...
function PhaseReveal({ category, results, cardRef, onDownload, downloading, onBack }) {
  ...
  const totalMale = rankedMale.reduce((s, r) => s + r.count, 0);
  const totalFemale = rankedFemale.reduce((s, r) => s + r.count, 0);
  const totalBase = rankedBase.reduce((s, r) => s + r.count, 0);
