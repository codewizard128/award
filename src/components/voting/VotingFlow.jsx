...
import { saveVotesLocally, loadVotesLocally, markSubmitted, hasSubmitted } from "../../lib/storage";
import { submitAllVotes } from "../../lib/appwrite";
import BottomNav from "../layout/BottomNav"; export default function VotingFlow({
    ...
    useEffect(() => {
        if (hasSubmitted()) navigate("/thank-you", { replace: true });
    }, [navigate]);
